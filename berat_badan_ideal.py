...
def load_data_from_sheets(sheet_url, sheet_name):
    ...
    creds = ServiceAccountCredentials.from_json_keyfile_name(
        "C:\\Users\\handi\\infra-volt-428716-f6-2b1f4cd5094d.json", scope
    )
...
if st.button("mulai"):
    ...
    actual_height_cm = (
        total_height_cm - height
    )  # Mengurangi pembacaan dari tinggi total
    ...
    tinggi = st.number_input(
        "Masukkan Tinggi Badan (dalam meter):", value=float(height)
    )
